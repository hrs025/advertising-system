                ...
                <div class="w3-row w3-padding-16">
                    ...
                    <div class="w3-row">
                        <div class="w3-quarter">
                            ...
                            <a href="add_pamphlet.php"><button class="btn w3-blue">Add Pamphlet</button></a>
...
WHERE up.`userid` = '$_SESSION[user]'";
                    $selorder1 = mysqli_query($con,$selorder)
                    or die("Error: ".mysqli_error($con));
                           while ($order = mysqli_fetch_array($selorder1))
                           {  
                            $total += $order['price'];
                            ?>
                            <tr>
 
                                <td width="10%" height="10%"><img src="userPamphlet/<?php echo $order['pamphletImg'];?>" /></td>
                                ...
                                <td><a href="deleteuseroderuser.php?userId=<?php echo $order['pamphletID']; ?>"><button type="button" class="btn btn-warning">Delete</button></a></td>
