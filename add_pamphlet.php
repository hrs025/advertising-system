                ...
                <div class="w3-row w3-padding-16">
                    ...
                    <div class="w3-row">
                        ...
                        <div class="w3-rest w3-padding-24">
                          <div class="w3-row">
    <form class="form-horizontal col-sm-7" role="form" action="http://localhost/ams/insert_pamphlet.php" method="post" enctype="multipart/form-data">
      <div class="form-group">
        ...
        <div class="form-group">
          <label class="control-label col-sm-2" for="email">Area</label>
            <div class="col-sm-10">
              <select  required name="area" id="areaId" class="w3-input">  
      ...
      <div class="form-group">
          <label class="control-label col-sm-2">No. Of Pamplet</label>
          <div class="col-sm-10">
             <input type="number"  required name="pamphlet" class="w3-input">
          </div>
      </div>
      <div class="form-group">
          <label class="control-label col-sm-2">Upload Banner</label>
          <div class="col-sm-10">
            <input type="file" name="file" class="w3-input"  required>
          </div>
      </div>
